...
from typing import *
from transformers import AutoConfig, AutoTokenizer, AutoModelForSequenceClassification, BertForSequenceClassification
...
class PLMVictim(Victim):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #self.plm = BertForSequenceClassification.from_pretrained(path, config=self.model_config)
