...
def load_dataset(
            ...
            clean_data_basepath: Optional[str] = './datasets/SentimentAnalysis/SST-2',
            **kwargs):
    ...
    if name == "Agnews":
        ...
        test_dataset = processor.get_dev_examples()
        train_dataset, dev_dataset = train_test_split(train_dataset, test_size=0.1, shuffle=False)
