...
def padding_zeros_vit(args, basic_subnet_path):
    ...
    #for head in range(1):
        ...
        if args.attack_pattern == "trigger":
            ...
            padding_zeros_vit_path = './saved_model/VisionTransformer/%s/%s/padding_zeros_vit_%s_head%s.pth' \
        ...
        model = VisionTransformer(patch_size=16, embed_dim=768, depth=12, num_heads=12, dim_heads=64, head=head, mlp_ratio=4,
                               num_classes=num_classes, subnet_dim=subnet_dim, qkv_bias=True,
