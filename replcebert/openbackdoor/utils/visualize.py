...
def display_results(config, results):
    ...
    display_result = {'poison_dataset': poison_dataset, 'poisoner': poisoner, 'poison_rate': poison_rate,
                      ...
                      "CACC" : CACC, 'ASR': ASR}
    # Loss_test_clean = results['test-clean']['loss']#for bertsource
    # Loss_test_poison = results['test-poison']['loss']
    # display_result = {'poison_dataset': poison_dataset, 'poisoner': poisoner, 'poison_rate': poison_rate,'target_label': target_label,
    #                   'Loss_test_clean': Loss_test_clean, 'Loss_test_poison': Loss_test_poison}
